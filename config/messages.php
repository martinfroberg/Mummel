...
//Locked user
define('YOUR_ACCOUNT_HAS_BEEN_LOCKED', "För många misslyckade försök! Ditt konto har blivit låst i 2 timmar.");
define('YOUR_ACCOUNT_IS_LOCKED', "Ditt konto är låst, försök igen senare.");
...
//Database
define('INSERT_INTO_DATABASE_FAILURE', "Okänt fel.");
define('SELECT_FROM_DATABASE_FAILURE', "Okänt fel.");
